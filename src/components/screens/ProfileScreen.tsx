...
export function ProfileScreen({ onNavigate, favorites, recent, myReviewsCount }: ProfileScreenProps) {
  return (
      ...
      <div className="bg-white p-6 pb-8 text-center border-b border-gray-100">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-8 mt-6">
            ...
            <div className="text-center">
              <div className="text-xl font-bold text-blue-600">{recent.length}</div>
              <div className="text-xs text-gray-500 uppercase tracking-wide">Check-ins</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-bold text-blue-600">{myReviewsCount}</div>
      ...
      <div className="flex-1 p-4">
        <Tabs defaultValue="favorites" className="w-full">
          ...
          <TabsContent value="recent" className="space-y-3">
            {recent.length === 0 ? (
              <div className="text-center text-gray-500 py-8 text-sm">
                Check in to a spot to track where you have been.
              </div>
            ) : (
              recent.map(spot => (
                <Card 
                ...
                >
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <div className="flex items-center text-xs text-gray-500 mt-1">
                      ...
                      {spot.lastCheckIn || 'Visited just now'}
                    </div>
                  </div>
                </Card>
              ))
