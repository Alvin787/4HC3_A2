...
export function HomeScreen({ onNavigate, spots, activeCategory, onCategoryChange, searchTerm, onSearchChange, onOpenFilters }: HomeScreenProps) {
      ...
      <div className="flex-1 p-4 space-y-4 overflow-y-auto">
        ...
        {spots.length === 0 ? (
          <div className="text-center text-gray-500 py-12 text-sm">
            No spots match your search. Try adjusting filters.
          </div>
        ) : (
          spots.map((spot) => (
            <Card 
